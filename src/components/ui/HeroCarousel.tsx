                                    ...
                                    <AnimatePresence mode='wait'>
                                        {selectedIndex === index && (
                                            <div className="w-full max-w-3xl space-y-2 md:space-y-4">
                                                ...
                                                >
                                                    <button 
                                                        className="relative overflow-hidden group/btn px-4 py-2 md:px-6 md:py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white font-semibold text-xs md:text-sm transition-all hover:bg-white/20 hover:scale-105 active:scale-95 flex items-center gap-2"
